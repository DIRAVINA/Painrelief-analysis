...
file_path<-"C:\\Users\\dirav\\Downloads\\caseStudy5.csv"
...
#Change box
boxplot(mydata$Change~mydata$Active,data=mydata,main="Change in Pain",xlab="Change Pain Rating",ylab="Devices",names=c("Active","Placebo"),col=c("green","darkgreen"),horizontal = TRUE)
